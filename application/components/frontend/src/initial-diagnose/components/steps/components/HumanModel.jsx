...
import HumanModelPopup from 'initial-diagnose/components/steps/components/HumanModelPopup';

import 'initial-diagnose/components/steps/components/styles/HumanBody.css';

const HumanModelWrapper = styled.div.attrs({ className: 'human-model-wrapper' })`
  position: relative;
`;
    ...
    <HumanModelWrapper>
      <div className="human-body">
        ...
        <svg
          ...
          id="left-shoulder"
          className="left-shoulder human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="109.532"
          height="46.594"
        ...
        <svg
          ...
          id="right-shoulder"
          className="right-shoulder human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="109.532"
          height="46.594"
          viewBox="0 0 109.532 46.594"
        ...
        <svg
          ...
          id="left-arm"
          className="left-arm human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="156.344"
          height="119.25"
        ...
        <svg
          ...
          id="right-arm"
          className="right-arm human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="156.344"
          height="119.25"
          viewBox="0 0 156.344 119.25"
        ...
        <svg
          ...
          id="left-leg"
          className="left-leg human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="93.626"
          height="250.625"
        ...
        <svg
          ...
          id="right-leg"
          className="right-leg human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="80"
          height="250.625"
        ...
        <svg
          ...
          id="left-hand"
          className="left-hand human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="90"
          height="38.938"
        ...
        <svg
          ...
          id="right-hand"
          className="right-hand human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="90"
          height="38.938"
          viewBox="0 0 90 38.938"
        ...
        <svg
          ...
          id="left-foot"
          className="left-foot human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="30"
          height="30"
          viewBox="0 0 30 30"
        ...
        <svg
          ...
          id="right-foot"
          className="right-foot human-model"
          xmlns="http://www.w3.org/2000/svg"
          width="90"
          height="38.938"
          viewBox="0 0 90 38.938"
